...
const AddCourse = () => {
  ...
  return (
    <div className="h-screen overflow-scroll flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0">
      <form>
        ...
        <div className="flex items justify-between flex-wrap">
          <div className="flex flex-col gap-1">
            <p>Course price</p>
            <input
